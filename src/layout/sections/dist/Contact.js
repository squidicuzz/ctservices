...
var Support = /** @class */ (function (_super) {
    ...
    Support.prototype.render = function () {
        return (react_1["default"].createElement("section", { className: 'support-container', id: "sales", "data-color": "rgb(92, 194, 228)" },
                                ...
                                react_1["default"].createElement("figure", { className: 'r' },
                                    ...
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        ...
                                        react_1["default"].createElement("span", null,
                                            ...
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " Our full-stack web development approach involves proficiently handling both front-end and back-end aspects to deliver comprehensive and dynamic web solutions.")),
                                        " "))),
                            react_1["default"].createElement("li", { className: "carousel__slide" },
                                react_1["default"].createElement("figure", { className: 'r' },
                                    react_1["default"].createElement("span", { className: 'to-center' },
                                    ...
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        ...
                                        react_1["default"].createElement("span", null,
                                            ...
                                            " ",
                                            react_1["default"].createElement("br", null),
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " As experts in Web3 and DApp development, we harness the power of decentralized technologies to build immersive and user-friendly applications.")),
                                        " "))),
                            react_1["default"].createElement("li", { className: "carousel__slide" },
                                react_1["default"].createElement("figure", { className: 'r' },
                                    react_1["default"].createElement("span", { className: 'to-center' },
                                    ...
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        ...
                                        react_1["default"].createElement("span", null,
                                            ...
                                            " ",
                                            react_1["default"].createElement("br", null),
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " We specialize in Solidity smart contract development, creating secure and efficient blockchain-based solutions tailored to your specific decentralized application needs.")),
                                        " "))),
                            react_1["default"].createElement("li", { className: "carousel__slide" },
                                react_1["default"].createElement("figure", { className: 'r' },
                                    react_1["default"].createElement("span", { className: 'to-center' },
                                        react_1["default"].createElement(image_1["default"], { className: "car b4", src: "/images/undraw_heatmap_uyye.svg", alt: "car", width: "500", height: "500" })),
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        " ",
                                        react_1["default"].createElement("span", null,
                                            ...
                                            " ",
                                            react_1["default"].createElement("br", null),
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " Our web design approach focuses on crafting user-centric and aesthetically pleasing websites that align with your brand identity and business goals.")),
                                        " "))),
                            react_1["default"].createElement("li", { className: "carousel__slide" },
                                react_1["default"].createElement("figure", { className: 'r' },
                                    react_1["default"].createElement("span", { className: 'to-center' },
                                        react_1["default"].createElement(image_1["default"], { className: "car b5", src: "/images/undraw_image_viewer_re_7ejc.svg", alt: "car", width: "500", height: "500" })),
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        " ",
                                        react_1["default"].createElement("span", null,
                                            react_1["default"].createElement("span", { className: 'text-motion section-title project-title to-quinary s' }, " Graphic Design"),
                                            react_1["default"].createElement("br", null),
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " Our graphic design services involve translating your brand identity and messaging into visually compelling designs. ")),
                                        " "))),
                            react_1["default"].createElement("li", { className: "carousel__slide" },
                                react_1["default"].createElement("figure", { className: 'r' },
                                    react_1["default"].createElement("span", { className: 'to-center' },
                                        react_1["default"].createElement(image_1["default"], { className: "car b6", src: "/images/undraw_instant_support_re_s7un.svg", alt: "car", width: "500", height: "500" })),
                                    react_1["default"].createElement("span", { className: 'nomors' },
                                        " ",
                                        react_1["default"].createElement("span", null,
                                            ...
                                            " ",
                                            react_1["default"].createElement("br", null),
                                            react_1["default"].createElement("span", { className: 'section-desc' }, " We offer technical consultation by deeply understanding your project goals and challenges, and then providing targeted expertise and strategic guidance to optimize your systems, resolve technical issues, and enhance overall project success.")),
                                        " ")))))),
            ...
            react_1["default"].createElement(image_1["default"], { className: "sales-2-land-pic", alt: 'front-logo', src: "/images/observe-up-opac-3.png", width: "3620", height: "1671" }),
