            ...
            react_1["default"].createElement("div", { className: "to-width to-height to-center to-flex-column" },
                react_1["default"].createElement("div", { className: 'to-left' },
                    ...
                    react_1["default"].createElement("div", { className: 'section-desc' },
                        ...
                        " services we offer: ")),
                react_1["default"].createElement("div", { className: 'packages to-flex to-gap to-wrap' },
                    ...
                    react_1["default"].createElement("div", { "data-aos": "fade-right", "data-aos-duration": "2000", "data-aos-anchor-placement": "bottom-bottom", className: 'service-package-3' },
                        react_1["default"].createElement("div", { className: 'service-package-sub' },
                            ...
                            react_1["default"].createElement("div", { className: 'contact-description' },
                                ...
                                " "))),
                    react_1["default"].createElement("div", { "data-aos": "fade-left", "data-aos-duration": "2500", "data-aos-anchor-placement": "bottom-bottom" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement("div", { className: 'contact-name-1 to-bold' },
                                " Legends: \u21D2 ",
                                react_1["default"].createElement("span", { className: 'we-logo-fourth to-bold' }, " (superscript) ")),
                            react_1["default"].createElement("div", { className: 'contact-description' },
                                " ",
                                react_1["default"].createElement("ul", null,
                                    " ",
                                    react_1["default"].createElement("li", { className: 'jekz-list' }, " \u00B9Final price may be adjusted or negotiated after review of report(s). "),
                                    " ",
                                    react_1["default"].createElement("li", { className: 'jekz-list' }, " \u00B2Additional  Time may be arranged and allotted when expiration time nears. "),
                                    " ",
                                    react_1["default"].createElement("li", { className: 'jekz-list' }, " \u00B3Final price may be adjusted if hours of support exceed 8 hours. "),
                                    " ",
                                    react_1["default"].createElement("li", { className: 'jekz-list' }, " \u2074Currency denomination may be negotiated. ")),
                                " "))))),
