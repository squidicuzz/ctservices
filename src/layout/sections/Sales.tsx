    ...
    return (
      <section id="offers" className='sales-container'>
        <div className="to-width to-height to-center to-flex">
            ...
            data-aos-duration="1500" data-aos-anchor-placement="bottom-bottom" className='sale-welcome-message'>What do we offer? <div className='color-effect'> in Cryptech Services, </div></div>
