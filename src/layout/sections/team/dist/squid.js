    ...
    Squid.prototype.render = function () {
        return (react_1["default"].createElement("div", { "data-aos": "fade-up", "data-aos-duration": "1000", "data-aos-anchor-placement": "bottom-bottom", className: "contacts-container" },
            ...
            react_1["default"].createElement("div", { className: "details-bg" },
                react_1["default"].createElement("div", { className: "contact-name squid-name" }, " Ercknard "),
                react_1["default"].createElement("div", { className: "contact-description" },
                    react_1["default"].createElement("ul", null,
                        react_1["default"].createElement("li", { className: "squid-list" }, " Web Designer "),
                        react_1["default"].createElement("li", { className: "squid-list" }, " Graphic Designer "),
                ...
                react_1["default"].createElement("div", { className: "to-flex to-gap z" },
                    react_1["default"].createElement("a", { className: "contact-button squid", href: "https://discord.com/users/615741889366458369", target: "_blank" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement("button", { type: "button", className: "home-button-txt" },
                                ...
                                " Discord"))),
                    react_1["default"].createElement("a", { className: "contact-button squid t", href: "mailto:ercknard@cryptech.services", target: "_blank" },
                        react_1["default"].createElement("div", null,
                            react_1["default"].createElement("button", { type: "button", className: "home-button-txt" },
