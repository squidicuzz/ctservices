  ...
  render() {
    return (
            ...
            <div data-aos="fade-right"
                    data-aos-duration="1500" data-aos-anchor-placement="bottom-bottom" className='color-effect section-title'> CRYPTECHTEST GAME </div>
                    ...
                    data-aos-duration="1500" className='section-desc'> Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</div>
                        <a data-aos="fade-up"
                    data-aos-duration="1500" className="home-button" href="https://cryptechtest.xyz/" target='_blank'><div><button type="button" className="home-button-txt">Join Us!</button></div></a>
                </div>
                </div>
                                </div>
      </section>
